package com.yummy.recipe.bootstrap;

import com.yummy.recipe.models.*;
import com.yummy.recipe.repositories.CategoryRepository;
...
public class LoadData implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
      recipeRepository.saveAll(getRecipes());
        log.debug("Successfully loaded all the data for bootstrap");
    }
    ...
    private List<Recipe> getRecipes(){
        ...
        if(!eachUOMOptional.isPresent())
            ...
            System.out.println("'EachUOM' not found");
        Optional<UnitOfMeasure> tableSpoonOptional = unitOfMeasureRepository.findByDescription("Tablespoon");
        if(!tableSpoonOptional.isPresent())
            //throw new RuntimeException("'TableSpoon' UOM not found....");
            System.out.println("'TableSpoon' UOM  not found");
        Optional<UnitOfMeasure> teaSpoonOptional = unitOfMeasureRepository.findByDescription("Teaspoon");
        if(!teaSpoonOptional.isPresent())
            //throw new RuntimeException("'Teaspoon' UOM not found....");
            System.out.println("'Teaspoon' UOM  not found");
        Optional<UnitOfMeasure> dashOptional = unitOfMeasureRepository.findByDescription("cup");
        if(!dashOptional.isPresent())
            //throw new RuntimeException("'Dash' UOM not found....");
            System.out.println("'Dash' UOM  not found");
        Optional<UnitOfMeasure> pintOptional = unitOfMeasureRepository.findByDescription("Ounce");
        if(!pintOptional.isPresent())
            //throw new RuntimeException("'Pint' UOM not found....");
            System.out.println("'Pint' UOM  not found");
        Optional<UnitOfMeasure> cupOptional = unitOfMeasureRepository.findByDescription("cup");
        if(!cupOptional.isPresent())
            //throw new RuntimeException("'Cup' UOM not found....");
            System.out.println("'Cup' UOM  not found");
        ...
        if(!americanCategory.isPresent())
            ...
            System.out.println("'American' category was not found..");
        ...
        if(!mexicanCategory.isPresent())
            ...
            System.out.println("'Mexican' category was not found..");
